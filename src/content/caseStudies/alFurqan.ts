...
export const alFurqan: CaseStudy = {
  ...
  hero: {
    ...
    alt: "Librairie Al Furqan — catalogue, search, multi-product cart and WhatsApp checkout.",
    caption: "An e-commerce flow shaped around local habits, not imported defaults.",
    width: 1200,
    height: 750,
  },
  facts: [
